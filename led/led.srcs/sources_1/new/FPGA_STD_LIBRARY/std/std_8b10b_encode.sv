...
logic 		ksel_latch;
logic 		disparity_latch;
logic [7:0]	data_in_latch;
logic [9:0]	data_out_latch;
logic 		RD_latch;

logic [9:0]	data_out_wire;
logic		disparity;
logic [7:0]	TXD;
logic		K;
logic [9:0]	code_group;
...
logic 	a,b,c,d,e,i_rdp,i_rdn,f,g,h,j;
